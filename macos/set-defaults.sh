...
# Set computer name.
sudo scutil --set ComputerName "jamesfiltness"
sudo scutil --set HostName "jamesfiltness"
sudo scutil --set LocalHostName "jamesfiltness"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "jamesfiltness"
